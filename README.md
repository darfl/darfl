...
- **Пишу аккуратные тесты.** Отсутствуют захардкоженные URL и заголовки. Всё вынесено в спецификации и фабрики. Eсли в API что-то меняется, можно исправить только в одном месте, а не в десяти тестах.
