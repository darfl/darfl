...
- **Пишу аккуратные тесты.** Отсутствуют захардкоженные URL и заголовки. Всё вынесено в спецификации и фабрикию. Eсли в API что-то меняется, можно исправить только в одном месте, а не в десяти тестах.
...
- **Генерирую данные, вникая в контекст.** Город зависит от штата, email и телефон — случайные, но валидные. JavaFaker в комбинации с кастомной логикой.
